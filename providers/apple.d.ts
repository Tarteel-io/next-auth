 ...
 */
export declare function generateClientSecret(components: {
    clientId: string;
    teamId: string;
    keyId: string;
    privateKey: string;
 ...
 * @default 15780000
 */
expires_in?: number): Promise<string>;
export default function Apple<P extends Record<string, any> = AppleProfile>(options: OAuthUserConfig<P>): OAuthConfig<P>;
